...
const knowledgeBase = [
    ...
    },
    {
        ...
        answer: '📝 Регистрация происходит через email и пароль. Если забыл пароль — используй функцию восстановления, написав администраторам на почту: "smartsocials@mail.ru". Тема письма и вопрос будут заполнены автоматически. Используй любой адрес для восстановления, ведь имя то одно, а пароль будет другим🥰.'
    },
   {
