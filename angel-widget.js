...
const knowledgeBase = [
    ...
    },
    {
        ...
        answer: '📝 Регистрация происходит через email и пароль. Если забыл пароль — используй функцию восстановления, написав администраторам на почту: "smartsocials@mail.ru". Тема письма и вопрос будут заполнены автоматически. Используй любой адрес для восстановления, вкль имя то олно, а пароль будет другим🥰.'
    },
   {
